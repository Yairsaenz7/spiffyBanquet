...
//				}
			...
			if (event.type == TouchEvent.TOUCH_UP) {
				...
				if (event.x > 400) {
					// stop moving the robot if over half the screen,the bg should start moving
					robot.stopRight();
				}
			}
	   ...
	   if( Tile.gameIsOver){
		...
		if (robot.isJumped()) {
			if(Tile.benitoIsDonezo == true)
				...
				if(robot.isDucked()== true){//if ducked show the rolling image
				...
				robot.setDucked(false);//set benito to not jumping since he is falling from edge now
				}
			}
		}
...
//		}
		...
		if (robot.getCenterY() > 500) {//robot has fallen
...
//		g.drawRect(robot.rectl, robot.rectt, robot.rectr - robot.rectl, robot.rectb-robot.rectt,Color.RED );
//		g.drawRect(robot.rect2l, robot.rect2t, robot.rect2r - robot.rect2l, robot.rect2b-robot.rect2t,Color.BLUE );
//		g.drawRect(robot.rect3l, robot.rect3t, robot.rect3r - robot.rect3l, robot.rect3b-robot.rect3t,Color.WHITE);//left hand
//		g.drawRect(robot.rect4l, robot.rect4t, robot.rect4r - robot.rect4l, robot.rect4b-robot.rect4t,Color.BLACK );//right hand
//		g.drawRect(robot.footLeftl, robot.footLeftt, robot.footLeftr - robot.footLeftl, robot.footLeftb-robot.footLeftt,Color.YELLOW );
//		g.drawRect(robot.footRightl, robot.footRightt, robot.footRightr - robot.footRightl, robot.footRightb-robot.footRightt,Color.GREEN );
		//g.drawRect(robot.yellowRedl, robot.yellowRedt, robot.yellowRedr - robot.yellowRedl, robot.yellowRedb-robot.yellowRedt,Color.LTGRAY );
		
		// First draw the game elements.		
		g.drawImage(currentSprite, robot.getCenterX() - 61,robot.getCenterY() - 13);
