...
public class Robot {
	...
	public void update() {
		...
		//if speed is negative,then move benito back
		if (speedX < 0) {
			centerX += speedX;
			speedX += 1;
		...
		//if benito is in the first half of screen, and speed  is positive
		//then move benito one speed unit
		if (centerX <= 200 && speedX > 0) {
			centerX += speedX;
		}
		//if benito is moving and at the center of screen, move the backgrounds
